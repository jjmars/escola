...
class GuardiansControllerTest < ActionController::TestCase
  ...
  test "should create guardian" do
    assert_difference('Guardian.count') do
      post :create, guardian: { address: @guardian.address, email: @guardian.email, name: @guardian.name, phone: @guardian.phone, school_id: @guardian.school_id, unit_id: @guardian.unit_id }
    end
  ...
  test "should update guardian" do
    patch :update, id: @guardian, guardian: { address: @guardian.address, email: @guardian.email, name: @guardian.name, phone: @guardian.phone, school_id: @guardian.school_id, unit_id: @guardian.unit_id }
    assert_redirected_to guardian_path(assigns(:guardian))
  end
